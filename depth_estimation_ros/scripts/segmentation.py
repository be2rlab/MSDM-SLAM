...
class Segmenter(object):
    def __init__(self, topic_kf,topic_in, topic_out):
        ...
        #self.config_file = '/home/ami/slam_ws/SeMask-Segmentation/SeMask-FPN/configs/semask_swin/ade20k/semfpn_semask_swin_large_patch4_window12_640x640_80k_ade20k.py'
