...
int main(int argc, char **argv)
{
    if(argc < 5)
    {
        cerr << endl << "Usage: ./stereo_inertial_sber_zed2_vi path_to_vocabulary path_to_settings path_to_sequence_folder_1 (path_to_image_folder_2 ... path_to_image_folder_N) " << endl;
        return 1;
    }
    ...
    gyro_calib <<      0.994887f,       0.000000f,       0.000000f,       0.005416f,
                       0.000000f,       1.000366f,       0.000000f,       0.002374f,  
                       0.000000f,       0.000000f,       0.998041f,      -0.001461f,
                       0.000000f,       0.000000f,       0.000000f,       1.000000f;
     
    acc_calib <<       1.018957f,       0.000000f,       0.000000f,      -0.096354f,  
                       0.000000f,       1.020408f,       0.000000f,       0.231649f,  
                       0.000000f,       0.000000f,       1.021836f,       0.007646f,
                       0.000000f,       0.000000f,       0.000000f,       1.000000f;
