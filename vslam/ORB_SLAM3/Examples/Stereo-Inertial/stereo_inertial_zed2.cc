...
int main(int argc, char **argv)
{
    if(argc < 5)
    {
        cerr << endl << "Usage: ./stereo_inertial_sber_zed2 path_to_vocabulary path_to_settings path_to_sequence_folder_1 (path_to_image_folder_2 ... path_to_image_folder_N) " << endl;
        return 1;
    }
...
void LoadImages(const string &strPathFolder, vector<string> &vstrImageLeft, vector<string> &vstrImageRight, vector<double> &vTimeStamps)
{
    string strPathLeft = strPathFolder + "/zed2_left";
    string strPathRight = strPathFolder + "/zed2_right";
