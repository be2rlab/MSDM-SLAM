...
int main(int argc, char **argv)
{
    if(argc < 5)
    {
        cerr << endl << "Usage: ./stereo_inertial_d455 path_to_vocabulary path_to_settings path_to_sequence_folder_1 (path_to_image_folder_2 ... path_to_image_folder_N) name_seq" << endl;
        return 1;
    }
...
void LoadImages(const string &strPathFolder, vector<string> &vstrImageLeft, vector<string> &vstrImageRight, vector<double> &vTimeStamps)
{
    string strPathLeft = strPathFolder + "/d455_infra1";
    string strPathRight = strPathFolder + "/d455_infra2";
    string strPathTimesLeft = strPathFolder +"/d455_times_infra1.txt";
